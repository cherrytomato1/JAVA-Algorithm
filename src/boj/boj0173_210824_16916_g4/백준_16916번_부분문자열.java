package boj.boj0173_210824_16916_g4;

import java.io.*;

public class 백준_16916번_부분문자열 {

	public static void main(String[] args) throws IOException{
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		System.out.println(solve(br.readLine(), br.readLine()) ? 1 : 0);
	}

	private static boolean solve(String targetString, String searchString) {
